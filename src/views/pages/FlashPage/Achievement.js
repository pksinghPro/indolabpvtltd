    ...
    <>
      <Box className={classes.descriptionbox}>
        <Box>
          ...
          <Box className={classes.downsubtext}>
            <Typography variant="h4">Lorem ipsum achievements</Typography>
            <Box className={classes.subboxes}>
              <Typography variant="body1">
                ...
                sed mauris.Lorem ipsum dolor sit amet consectetur. Lobortis
                tincidunt molestie rhoncus a ac. Purus est aliquet eu duis
                ultricies ut est urna euismod. Sit viverra id condimentum
                convallis dictum sed mauris. Lorem ipsum dolor sit amet
                ...
                condimentum convallis dictum sed mauris.Lorem ipsum dolor sit
                amet consectetur. Lobortis tincidunt molestie rhoncus a ac.
                Purus est aliquet eu duis ultricies ut est urna euismod. Sit
                viverra id condimentum convallis dictum sed mauris.
              </Typography>
            </Box>
          </Box>
        </Box>
